...
// components
import { Nav, Placeholder } from './components/components.js'
// Assets
import { formsData } from './assets/assets.js'

//TODO: Wrap the App in React.memo to minimize reflows 
    ...
    <div className="app-container" style={style}>
      ...
      <main className="page-content" role="main">
        <Routes>
          ...
          {/* Dynamic placeholder route  */}
          <Route path="/form/:formId" element={<Placeholder formsData={formsData}/>} />
          {/* optional list-of-forms UI */}
          {/* <Route path="/form"     element={<div>Select a form (or open from the nav)</div>} /> */}
